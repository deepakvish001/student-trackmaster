...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        'glow': '0 0 20px hsl(25 100% 60% / 0.2)',
        'glow-lg': '0 0 30px hsl(25 100% 60% / 0.25)',
        'purple-glow': '0 0 20px hsl(280 100% 70% / 0.25)',
        'blue-glow': '0 0 20px hsl(195 100% 60% / 0.25)',
        'green-glow': '0 0 20px hsl(160 100% 50% / 0.25)',
        'pink-glow': '0 0 20px hsl(340 100% 65% / 0.25)',
        'professional': '0 8px 32px rgba(255, 140, 0, 0.12)',
        'elevated': '0 12px 48px rgba(255, 140, 0, 0.15)',
        'modern': '0 10px 40px rgba(255, 140, 0, 0.15), 0 0 20px rgba(59, 130, 246, 0.1), 0 0 10px rgba(147, 51, 234, 0.08)',
      },
      backdropBlur: {
        'xs': '2px',
        'sm': '4px', 
      ...
      backgroundImage: {
        ...
        'professional-gradient': 'linear-gradient(135deg, hsl(25 100% 60% / 0.03), hsl(195 100% 60% / 0.03), hsl(280 100% 70% / 0.03))',
      },
    },
  },
