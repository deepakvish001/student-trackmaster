...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        'glow': '0 0 20px hsl(var(--electric-blue) / 0.2)',
        'glow-lg': '0 0 30px hsl(var(--electric-blue) / 0.3)',
        'purple-glow': '0 0 20px hsl(var(--vibrant-purple) / 0.2)',
        'green-glow': '0 0 20px hsl(var(--emerald-green) / 0.2)',
