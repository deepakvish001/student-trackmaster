...
ALTER TABLE public.user_profiles ADD COLUMN new_role public.user_role DEFAULT 'user'::public.user_role;
...
ALTER TABLE public.user_profiles RENAME COLUMN new_role TO role;

-- Set the new role column as NOT NULL
