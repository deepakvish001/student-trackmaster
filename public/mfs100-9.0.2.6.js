...
// Make sure the functions are available on the window object
window.GetMFS100Info = GetMFS100Info;
window.GetMFS100KeyInfo = GetMFS100KeyInfo;
window.CaptureFinger = CaptureFinger;
window.VerifyFinger = VerifyFinger;
window.MatchFinger = MatchFinger;
window.GetPidData = GetPidData;
window.GetProtoPidData = GetProtoPidData;
window.GetRbdData = GetRbdData;
